...
export default function Step4Product({
  ...
  async function onSubmit(
    ...
    setSubmitting(true);
    setProductName1(formik.values.productName1);
    setProductName2(formik.values.productName2);
    setProductName3(formik.values.productName3);
    setProductName4(formik.values.productName4);
    setProductName5(formik.values.productName5);

    setProductDescription1(formik.values.productDescription1);
    setProductDescription2(formik.values.productDescription2);
    setProductDescription3(formik.values.productDescription3);
    setProductDescription4(formik.values.productDescription4);
    setProductDescription5(formik.values.productDescription5);
  ...
  const handleInputChangeProductName3 = (event) => {
    ...
    setProductName3(event.target.value);
    formik.handleChange(event);
  };
  ...
  const handleInputChangeProductName4 = (event) => {
    ...
    setProductName4(event.target.value);
    formik.handleChange(event);
  };
  ...
  const handleInputChangeProductName5 = (event) => {
    ...
    setProductName5(event.target.value);
    formik.handleChange(event);
  };
  ...
  const handleInputChangeProductDescription1 = (event) => {
    ...
    setProductDescription1(event.target.value);
    formik.handleChange(event);
  };
  ...
  const handleInputChangeProductDescription2 = (event) => {
    ...
    setProductDescription2(event.target.value);
    formik.handleChange(event);
  };
  ...
  const handleInputChangeProductDescription3 = (event) => {
    ...
    setProductDescription3(event.target.value);
    formik.handleChange(event);
  };
  ...
  const handleInputChangeProductDescription4 = (event) => {
    ...
    setProductDescription4(event.target.value);
    formik.handleChange(event);
  };
  ...
  const handleInputChangeProductDescription5 = (event) => {
    ...
    setProductDescription5(event.target.value);
    formik.handleChange(event);
  };
  ...
  useEffect(() => {
    console.log('suggestionErrorProductName1', suggestionErrorProductName1);
    console.log('suggestionErrorProductName2', suggestionErrorProductName2);
    console.log('suggestionErrorProductName3', suggestionErrorProductName3);
    console.log('suggestionErrorProductName4', suggestionErrorProductName4);
    console.log('suggestionErrorProductName5', suggestionErrorProductName5);
  }, [
  ...
  const handleSuggestionClickProductDescription1 = (suggestion) => {
    ...
    setProductDescription1(suggestion);
  };
  const handleSuggestionClickProductDescription2 = (suggestion) => {
    ...
    setProductDescription2(suggestion);
  };
  const handleSuggestionClickProductDescription3 = (suggestion) => {
    ...
    setProductDescription3(suggestion);
  };
  const handleSuggestionClickProductDescription4 = (suggestion) => {
    ...
    setProductDescription4(suggestion);
  };
  const handleSuggestionClickProductDescription5 = (suggestion) => {
    ...
    setProductDescription5(suggestion);
  };
