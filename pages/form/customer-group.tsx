...
export default function Step3CustGroup({ fbPixelId, secretKey }) {
  ...
  useEffect(() => {
    router.prefetch(ROUTE_PATH.productAndService);
  }, [router]);
  ...
  }, [selectedRadioStep3_1, selectedRadioStep3_2, selectedRadioStep3_3]);
        ...
        const responsePromise = fetch(
          '/api/inputSuggestion/getStep3SuggestionsCustomerDescription',
          {
            ...
            body: JSON.stringify({
              ...
              customerDescription1: formik.values.customerDescription1,
              customerDescription2: formik.values.customerDescription2,
              customerDescription3: formik.values.customerDescription3,
              customerIncome1,
              customerIncome2,
              customerIncome3,
