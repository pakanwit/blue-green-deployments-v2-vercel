...
export default function Step5KeySuccess({ fbPixelId, secretKey, xPixelId }) {
  ...
  useEffect(() => {
    ...
    if (formData[formDataTitle.FORM5_1]) {
      formik.setFieldValue(
        formDataTitle.FORM5_1,
        formData[formDataTitle.FORM5_1].value,
      );
    }
    if (formData[formDataTitle.FORM5_2]) {
      formik.setFieldValue(
        formDataTitle.FORM5_2,
        formData[formDataTitle.FORM5_2].value,
      );
    }
    if (formData[formDataTitle.FORM5_3]) {
      formik.setFieldValue(
        formDataTitle.FORM5_3,
        formData[formDataTitle.FORM5_3].value,
      );
    }
    if (formData[formDataTitle.FORM5_4]) {
      formik.setFieldValue(
        formDataTitle.FORM5_4,
        formData[formDataTitle.FORM5_4].value,
      );
    }
    if (formData[formDataTitle.FORM5_5]) {
      formik.setFieldValue(
        formDataTitle.FORM5_5,
        formData[formDataTitle.FORM5_5].value,
      );
    }
    if (formData[formDataTitle.FORM5_6]) {
      formik.setFieldValue(
        formDataTitle.FORM5_6,
        formData[formDataTitle.FORM5_6].value,
      );
    }
  }, []);
  ...
  useEffect(() => {
    if (!session) {
      event('Step5KeySuccess_component_view', {
        category: 'Component View',
        label: 'Step5KeySuccess Component View',
      });
    }
  }, [session]);
  ...
  const handleBackButton = () => {
    ...
    router.push(ROUTE_PATH.productAndService);
  };
        ...
        const responsePromise = fetch(
          '/api/inputSuggestion/getStep5SuggestionsKeySuccess',
          {
            ...
            body: JSON.stringify({
              ...
              successFactors1: formik.values.successFactors1,
              successFactors2: formik.values.successFactors2,
