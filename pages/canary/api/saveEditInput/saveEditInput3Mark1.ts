...
export default async function handler(request, response) {
  const saveEditInput3Mark1Handler = async (req, res) => {
  ...
  const saveEditInput3Mark1HandlerWithApiKeyValidation = withApiKeyValidation(
    saveEditInput3Mark1Handler
  );

  await saveEditInput3Mark1HandlerWithApiKeyValidation(request, response);
}
