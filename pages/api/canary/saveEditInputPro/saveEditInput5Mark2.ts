...
export default async function handler(request, response) {
  const saveEditInput5Mark2Handler = async (req, res) => {
  ...
  const saveEditInput5Mark2HandlerWithApiKeyValidation = withApiKeyValidation(
    saveEditInput5Mark2Handler
  );

  await saveEditInput5Mark2HandlerWithApiKeyValidation(request, response);
}
