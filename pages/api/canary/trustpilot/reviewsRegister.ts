...
async function getReviews(req, res) {
  try {
    ...
    const hardcodedReview1: IReviewsResponse = {
      ...
      reviewText:
        "Very easy to use and with a professional outcome! saved me so much money.",
    ...
    const hardcodedReview2: IReviewsResponse = {
      ...
      ratingUrl: "https://images-static.trustpilot.com/api/stars/5/star.svg",
      reviewText:
        "Easy to use system. Final plan is a good reflection of our business and is very specific to our sector..",
