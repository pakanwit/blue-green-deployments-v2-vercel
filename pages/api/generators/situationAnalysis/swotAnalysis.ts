...
interface ISituationAnalysisSwotAnalysis {
...
export const situationAnalysisSwotAnalysis = (
  request: ISituationAnalysisSwotAnalysis,
) => {
  const {
  ...
  const promptTemplates = {
    ...
    de: `
                        ...
                        Verwenden Sie 250 Wörter, um dieses ${situ2TopicDE} zu generieren.
    ...
    fr: `Vous êtes un consultant professionnel et un client vous approche pour rédiger un ${situ2TopicFR} détaillé pour un plan d'affaires.
                        ...
                        utilisez environ 250 mots pour générer ce ${situ2TopicFR}.
                        ...
                        Voici le ${situ2TopicFR} que vous avez élaboré :`,
    es: `Eres un consultor profesional y un cliente te pide que escribas un detallado ${situ2TopicES} para un plan de negocios.
                        ...
                        usa alrededor de 250 palabras para generar este ${situ2TopicES}.
                        ...
                        Este es el ${situ2TopicES} que has elaborado:`,
    it: `Sei un consulente professionale e un cliente ti chiede di scrivere un dettagliato ${situ2TopicIT} per un piano aziendale.
                        ...
                        usa circa 250 parole per generare questo ${situ2TopicIT}.
                        ...
                        Questo è il ${situ2TopicIT} che hai elaborato:`,
    nl: `
                        ...
                        gebruik ongeveer 250 woorden om deze ${situ2TopicNL} te genereren.
                        ...
                        Dit is de ${situ2TopicNL} die je hebt bedacht:`,
    ja: `
                        ...
                        これらはさらなる指示です：
                        この${situ2TopicJA}を生成するために約250語を使用します。
    ...
    ar: `
                        ...
                        استخدم حوالي 250 كلمة لإنشاء هذا ${situ2TopicAR}.
                        ...
                        هذا هو ${situ2TopicAR} الذي ابتكرته:`,
    sv: `
                        ...
                        använd cirka 250 ord för att generera detta ${situ2TopicSV}.
                        ...
                        Detta är den ${situ2TopicSV} du kom upp med:`,
    fi: `
                        ...
                        käytä noin 250 sanaa tämän ${situ2TopicFI} luomiseen.
                        ...
                        Luo kaikki suomeksi.
                        Tämä on ${situ2TopicFI}, jonka loit:`,
    da: `
                        ...
                        brug omkring 250 ord til at generere denne ${situ2TopicDA}.
                        ...
                        Dette er den ${situ2TopicDA} du kom op med:`,
    no: `
                        ...
                        bruk omtrent 250 ord for å generere denne ${situ2TopicNO}.
